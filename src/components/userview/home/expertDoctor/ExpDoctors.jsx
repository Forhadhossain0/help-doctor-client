...
console.log(doctor)
    ...
    return (
        <div className="h-fyll ">
        <div>
            <h1 className="text-3xl font-bold mx-auto text-center">Our Expert Doctors</h1>
            <p className="p-3 md:w-[70%]  mx-auto text-center">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inve ntore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
        </div>

       

         <div className="grid  grid-cols-1 md:grid-cols-3 gap-5 p-5 m-5 w-full ">
         ...
         { doctor?.slice(2,5).map(doctor=>
                ...
                <div className="p-8 rounded-xl ">
                 ...
                 <h1 className="text-xl font-bold pt-4">{doctor.doctorName}</h1>
